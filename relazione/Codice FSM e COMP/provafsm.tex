...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
        ...
        \draw   (0) edge                    node {\texttt{i\_rst=1}}                                            (1)
                ...
                (2) edge                    node {}                                                             (5)
                (3) edge                    node [xshift=-10pt] {\texttt{\emph{cond4}}}                         (5)
                (3) edge[bend right,left]   node {\texttt{\emph{!cond4}}}                                       (9)
                (4) edge                    node[left] {\texttt{\emph{!cond6}}}                                 (7)
                (4) edge                    node [at start, yshift=7pt, xshift=25pt] {\texttt{\emph{cond6}}}    (5)
                (5) edge                    node {}                                                             (6)
                (6) edge[bend right, right] node {\texttt{\emph{cond2}}}                                        (2)
                (6) edge[right]             node [at start, xshift=-43pt] {\texttt{\emph{cond3}}}               (3)
                (6) edge                    node [at start, xshift=-15pt] {\texttt{\emph{cond5}}}               (4)
                (6) edge[left]              node {\texttt{\emph{cond7}}}                                        (8)
                (7) edge                    node {}                                                             (5)
